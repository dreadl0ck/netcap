#!/bin/bash
#
# Build and push the Netcap Database Server container
#

set -e

# Image configuration
IMAGE_NAME="netcap-dbs-server"
...
echo "[INFO] Building netcap database server container"
...
# Test the image
# echo "[INFO] Testing container health check..."
...
# else
#     echo "[WARN] Health check failed (container may need more time to initialize)"
# fi
...
echo "  docker run -d -p 8080:8080 -v netcap-dbs-data:/data ${IMAGE_TAG}"
echo ""
echo "To build and push multi-platform images:"
echo "  export NETCAP_PUSH_IMAGES=true"
echo "  zeus build-dbs-server"
echo ""
