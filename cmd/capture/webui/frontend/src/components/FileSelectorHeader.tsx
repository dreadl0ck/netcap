...
// These objects are created once and reused, preventing unnecessary re-renders
const SELECT_SX = {
  color: 'inherit',
 ...
 */
export default function FileSelectorHeader({
  inputFiles,
  status,
  switchingFile,
  onFileChange,
  ...
  // Memoize completed files computation to avoid recalculating on every render
  const completedFiles = useMemo(() =>
    (inputFiles?.filter((f: any) => f.isCompleted) || [])
  ...
  // Memoize renderValue to prevent recreation and ensure stable reference
