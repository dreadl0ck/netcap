...
func addDestinationPort(trx *maltego.Transform, portStr string, port *types.Port, min, max uint64, ip *types.Host, path string) {
	...
	ent := addEntityWithPath(trx, "netcap.DestinationPort", portStr+"\n"+serviceName, path)
