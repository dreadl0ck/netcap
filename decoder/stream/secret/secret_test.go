...
// FTP Harvester test
func TestFTPSecretHarvester(t *testing.T) {
...
// HTTP Harvester test
func TestHTTPSecretHarvester(t *testing.T) {
...
// IMAP Harvester test
func TestIMAPSecretHarvester(t *testing.T) {
...
func TestTelnetSecretHarvester(t *testing.T) {
...
func TestSMTPSecretHarvester(t *testing.T) {
...
// TestHTTPFormSecrets tests extraction of credentials from HTTP POST form data
func TestHTTPFormSecrets(t *testing.T) {
...
// TestHTTPFormSecretsEdgeCases tests edge cases for HTTP form credential extraction
func TestHTTPFormSecretsEdgeCases(t *testing.T) {
