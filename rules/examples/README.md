...
### `modbus_hunt.yml`
**Focus**: Parsed Modbus requests, discovery cardinality, and visibility/coverage triage.
**Maturity**: 14 hunt templates, six enabled by default; site-dependent rules and baseline collection are disabled. No automatic blocking or other response actions.
